...
var As = function() {
  ...
  return Object.defineProperty(t2.prototype, "wo", {
    ...
    return this.ao = u, 0 !== o.length || a ? {
      snapshot: new ds(this.query, t3.fo, i, o, t3.mutatedKeys, 0 === u, a, false),
      To: s
    } : {
      To: s
    };
  ...
  return __awaiter(this, void 0, void 0, function() {
    ...
    return __generator(this, function(l2) {
      switch (l2.label) {
        ...
        case 1:
          return s = l2.sent(), u = new As(e, s.Bn), a = u._o(s.documents), c = hn.createSynthesizedTargetChangeForCurrentChange(i, o && "Offline" !== t2.onlineState), h = u.applyChanges(a, t2.isPrimaryClient, c), zs(t2, i, h.To), f = new ks(e, i, u), [2, (t2.Po.set(e, f), t2.Vo.has(i) ? t2.Vo.get(i).push(e) : t2.Vo.set(i, [e]), h.snapshot)];
      }
    });
  });
}
    ...
    return __generator(this, function(r) {
      switch (r.label) {
        ...
        case 2:
          return [3, 5];
        case 3:
          return Gs(n, i.targetId), [4, Hi(n.localStore, i.targetId, true)];
        case 4:
          r.sent(), r.label = 5;
        case 5:
          return [2];
...
function Vs(t2, e, i) {
  return __awaiter(this, void 0, void 0, function() {
    ...
    return __generator(this, function(r) {
      switch (r.label) {
        case 0:
          return (n = F2(t2)).sharedClientState.updateQueryState(e, "rejected", i), o = n.Co.get(e), (s = o && o.key) ? (u = (u = new We(ct.comparator)).insert(s, Nt.newNoDocument(s, K2.min())), a = sn().add(s), c = new cn(K2.min(), /* @__PURE__ */ new Map(), new $e(q2), u, a), [4, Fs(n, c)]) : [3, 2];
        case 1:
        ...
        case 3:
          return false !== e || false === n.$o ? [3, 7] : (c = [], h = Promise.resolve(), n.Vo.forEach(function(t3, e2) {
            n.sharedClientState.isLocalQueryTarget(e2) ? c.push(e2) : h = h.then(function() {
              return Gs(n, e2), Hi(n.localStore, e2, true);
            }), Bo(n.remoteStore, e2);
          }), [4, h]);
        case 4:
...
function Zu(t2, n) {
  ...
  return Gu(r = H2.fromString.apply(H2, __spreadArray([t2.path], i)).child(H2.fromString(n))), new Ju(t2.firestore, null, r);
}
function ta2(t2, n) {
  for (var r, i = [], o = 2; o < arguments.length; o++)
    i[o - 2] = arguments[o];
  ...
  return __extends(n, e), n.prototype._apply = function(t2) {
    var e2 = Ta(t2.firestore), n2 = function(t3, e3, n3, r, i, o, s) {
      ...
      if (i.isKeyField()) {
        ...
        "in" !== o && "not-in" !== o && "array-contains-any" !== o || uc2(s, o), u = Ra2(n3, "where", s, "in" === o || "not-in" === o);
...
var bc2 = function(e) {
  ...
  return __extends(n, e), n.prototype.get = function(t2) {
    ...
    return e.prototype.get.call(this, t2).then(function(t3) {
      return new za2(n2._firestore, i, r._key, t3._document, new Qa(false, false), r.converter);
    });
  }, n;
}(function() {
  function t2(t3, e) {
  ...
  return t2.iu = function(e, n, r) {
    ...
    return ("cache" === (null == t3 ? void 0 : t3.source) ? function(t4) {
      ...
      return function(t5, e3) {
        ...
        return new za2(e2, o, t4._key, n, new Qa(null !== n && n.hasLocalMutations, true), t4.converter);
      });
